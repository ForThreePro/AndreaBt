...
handler.before = async function (m, { conn, groupMetadata }) {
  try {
    ...
    try {
      ...
      pp = 'https://files.evogb.win/iuWAaj.jpg' // URL STRAWBERRY FALLBACK
    }
...
`💗 𓆩 ***𝗘𝗫𝗣𝗨𝗟𝗦𝗔𝗗𝗔*** 𓆪 💗\n\n🍓 *${userTag}* fue retirada de *${groupName}*`
    ...
    console.error("Error en Bienvenida Strawberry:", e)
  }
  return!0
}
